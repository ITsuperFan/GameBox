...
namespace GameBox
{
    public sealed class ComponentManagerSLinkedList : IListDataStructure<IComponent>
    {
        /// <summary>
        /// 单链表实例
        /// </summary>
        private readonly SLinkedList<IComponent> m_SLinkedList = new SLinkedList<IComponent>();
        ...
        public IComponent GetFirstNode()
        {
        ...
        public IComponent GetNode(Func<IComponent, bool> t_Handler)
        {
        ...
        public void RemoveNode(Func<IComponent, bool> t_Handler)
        {
            var t_ToList = m_SLinkedList.ToList(); //转换成System.List
            for (int i = 0; i < t_ToList.Count; i++)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public IListDataStructure<IComponent> Sort()
        {
        ...
        /// <returns></returns>
        public bool Contains(IComponent t_Value)
        {
            var t_ToList = m_SLinkedList.ToList(); //转换成System.List
