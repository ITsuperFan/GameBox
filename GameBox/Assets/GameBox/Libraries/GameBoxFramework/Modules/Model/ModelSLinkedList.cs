...
{
    public sealed class ModelSLinkedList : IListDataStructure<BaseModel>
    {
        /// <summary>
        /// 单链表实例
        /// </summary>
        private readonly SLinkedList<BaseModel> m_SLinkedList = new SLinkedList<BaseModel>();
        ...
        public void AddNode(BaseModel t_Node)
        {
        ...
        public BaseModel GetNode(Func<BaseModel, bool> t_Handler)
        {
        ...
        public void RemoveNode(Func<BaseModel, bool> t_Handler)
        {
            var t_ToList = m_SLinkedList.ToList(); //转换成System.List
            for (int i = 0; i < t_ToList.Count; i++)
            {
        ...
        /// </summary>
        /// <returns></returns>
        public IListDataStructure<BaseModel> Sort()
        {
        ...
        /// <returns></returns>
        public bool Contains(BaseModel t_Value)
        {
            var t_ToList = m_SLinkedList.ToList(); //转换成System.List
