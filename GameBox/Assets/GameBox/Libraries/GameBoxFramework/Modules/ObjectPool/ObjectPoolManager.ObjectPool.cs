        ...
        private sealed class ObjectPool<T> : ObjectPoolBase, IObjectPool<T> where T : ObjectBase
        {
            ...
            public override int Capacity
            {
                ...
                set
                {
                    if (value < 0)
                    {
                        throw new GameBoxFrameworkException("Capacity is invalid.");
                    }
            ...
            public override float ExpireTime
            {
                ...
                set
                {
                    if (value < 0f)
                    {
                        throw new GameBoxFrameworkException("ExpireTime is invalid.");
                    }
            ...
            public void Register(T obj, bool spawned)
            {
                if (obj == null)
                {
                    throw new GameBoxFrameworkException("Object is invalid.");
                }
            ...
            public void Unspawn(object target)
            {
                if (target == null)
                {
                    throw new GameBoxFrameworkException("Target is invalid.");
                }
                ...
                throw new GameBoxFrameworkException(string.Format("Can not find target in object pool '{0}'.", TextHelper.GetFullName<T>(Name)));
            }
            ...
            public void Release(int toReleaseCount, ReleaseObjectFilterCallback<T> releaseObjectFilterCallback)
            {
                ...
                {
                    throw new GameBoxFrameworkException("Release object filter callback is invalid.");
                }
                ...
                foreach (ObjectBase toReleaseObject in toReleaseObjects)
                {
                    ...
                    {
                        throw new GameBoxFrameworkException("Can not release null object.");
                    }
                    ...
                    if (!found)
                    {
                        throw new GameBoxFrameworkException("Can not release object which is not found.");
                    }
                }
            }
