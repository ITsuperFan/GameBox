...
namespace GameBoxFramework.EventPool
{
    public sealed class EventPoolManagerSLinkedList : IListDataStructure<IEventTopic>
    {
        ...
        /// 单链表实例
        /// </summary>
        private readonly SLinkedList<IEventTopic> m_SLinkedList = new SLinkedList<IEventTopic>();
        ...
        public IEventTopic GetFirstNode()
        {
        ...
        /// <typeparam name="T">节点数据类型</typeparam>
        /// <returns>返回的节点实例</returns>
        public IEventTopic GetLastNode()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public IListDataStructure<IEventTopic> Sort()
        {
        ...
        /// <returns></returns>
        public bool Contains(IEventTopic t_Value)
        {
            var t_ToList = m_SLinkedList.ToList(); //转换成System.List
